...
public class Character
{
    ...
    public void move(Room loc)
    {
        ...
        sane();
        location.removeCharacter(this); // this removes the character at the current location
        location = loc;
        sane();
        location.addCharacter(this); // this adds the character to the new location 
    }
}
